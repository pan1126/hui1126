...
<style scoped lang='less'>
	...
	.mui-icon-home:before{	
		.mui-icon(url(../../statics/imgs/1.png))
	}

	.mui-icon-email:before{		
		
		.mui-icon(url(../../statics/imgs/2.png))		
	}
	.mui-icon-chatbubble:before{		
	
		.mui-icon(url(../../statics/imgs/3.png))		
		
	}
	.mui-icon-location:before{		
		.mui-icon(url(../../statics/imgs/4.png))		
		
	}
	.mui-icon-search:before{		
		.mui-icon(url(../../statics/imgs/5.png))		
		
	}
	.mui-icon-phone:before{	
		.mui-icon(url(../../statics/imgs/6.png))		
